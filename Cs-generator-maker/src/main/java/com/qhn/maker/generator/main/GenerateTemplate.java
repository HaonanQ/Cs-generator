...
import com.qhn.maker.generator.file.DynamicFileGenerator;
...
public abstract class GenerateTemplate {
    ...
    protected String getJarPath(String outputPath, Meta meta) throws IOException, InterruptedException {
        // 构建 jar 包
    ...
    protected String getSourceCopyDestPath(Meta meta, String outputPath) {
