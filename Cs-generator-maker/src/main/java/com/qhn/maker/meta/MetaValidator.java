...
import com.qhn.maker.meta.enums.FileGenerateTypeEnum;
import com.qhn.maker.meta.enums.FileTypeEnum;
import com.qhn.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "qhn");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.qhn");
